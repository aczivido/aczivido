...
<title>Cenni storici del castello Brivio a Zivido</title>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="1%">&nbsp;</td>
    <td width="93%" align="left" valign="top"><img src="/zivido/castello/castello.png" width="426" height="184"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="93%"><h3>Cenni storici del Castello o Villa Brivio Sforza</h3></td>
    <td width="2%">&nbsp;</td>
    <td width="2%" align="center" valign="top"><img src="/colori/DFDF00.gif" width="2" height="100%"></td>
    <td width="2%">&nbsp;</td>
  </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="93%" valign="top"><p>
        Denominata castello dalla tradizione locale, l'antica residenza dei marchesi 
        Brivio a Zivido &egrave; da pi&ugrave; voci ritenuta, ma senza alcuna 
        conferma di tipo documentario, gi&agrave; propriet&agrave; di quei Della 
      ...
      si vorrebbe trecentesco: cio&egrave;, almeno parte della torre quadrangolare, 
        ...
        due corti, cos&igrave; formatesi, la minore, delimitata da semplice parete 
        muraria di chiusura, prospetta sulla via, mentre la maggiore &egrave; rivolta a ovest, verso la via Emilia.<br>
        Malgrado la discreta bibliografia - che di volta in volta lo ha definito 
      castello, palazzotto o villa - il castello di Zivido &egrave; stato pi&ugrave; volte dimenticato, ad esempio da note guide comprendenti anche la pianura 
        intorno a Milano.<br>
      ...
      della Provincia di Milano, pubblicato nel 1985, nonch&eacute; citato nel 
        censimento delle opere fortificate nella Lombardia, edito, per la zona 
        relativa, nel 1990, in cui pu&ograve; rientrare - come suggerisce a chi 
        ...
        agricolo fortificato. Infine, il castello &egrave; compreso sia in studi 
        ...
        repertorio (1992), dedicato alla Lombardia da salvare.<br>
        (&#133;) E' verosimile che, alla pari dei castelli in pianura e risalenti 
        ad et&agrave; viscontea, anche la fabbrica di Zivido fosse, agli inizi, 
        ...
        archi, mensole). Cio&egrave;, anche nella costruzione del castello di 
        Zivido, l'utilizzazione del materiale pi&ugrave; immediatamente disponibile, 
        ...
        cos&igrave;, derivarne un conseguente, maggior senso di unitariet&agrave;.<br>
        Nel contempo, forse anche l'insediamento di Zivido pu&ograve; riflettere 
        ...
        (1559-1707), le cui testimonianze, pi&ugrave; importanti e significative 
        ...
        fiumi, spesso non senza improntare di s&eacute;, come &egrave; stato pi&ugrave; volte affermato, l'intero territorio. Non sembra, infatti, da escludere 
      ...
      utilizzabile, costituita da castelli feudali, o, comunque, privati.<br>
      ...
      a causa della reciproca convivenza.<br>
      Pi&ugrave; tardi, in effetti, nel 1515 e nel corso della battaglia dei 
        Giganti, il castello di Zivido sar&agrave; quasi completamente distrutto, 
        come da tradizione ormai accettata da tutti gli studiosi.<br>
      ...
      in particolare, anche alcuni avanzi di un porticato, gi&agrave; aperto 
        sulla corte maggiore a ovest. Ma, poiche&egrave; il castello fu ricostruito 
        il secolo seguente, &egrave; molto difficile, allo stato attuale, distinguere 
        ...
        attuata nel Cinquacento di notevole vastit&agrave;, data la pressoch&egrave; 
      continua omogeneit&agrave; dei materiali costruttivi (in particolare, 
        dei mattoni e delle malte).<br>
        (&#133;) Se gi&agrave; dal 22 giugno 1251 &egrave; menzionata, nel borgo 
        ...
        al castello, ma anche al passaggio di propriet&agrave; alla medesima famiglia, 
        sino al documento citato dagli studiosi, in data 9 luglio 1575. Secondo 
        quanto sar&agrave; affermato nel 1583, alla data doveva risalire un istrumento 
        rogato dal notaio Giovanni Battista Bombello, per cui la &quot;casa da 
        gentilhuomo&quot; nel luogo di Zivido, con il suo &quot;castelletto&quot;, 
        gi&agrave; acquistata dal massaro Capponi (forse lo stesso coinvolto nella 
        lite per la chiesetta di S. Maria della Nativit&agrave; &quot;di Settembre&quot;) 
        era sottoposta all'eredit&agrave; della famiglia Brivio.<br>
        Gi&agrave; ristrutturato, e non pi&ugrave; allo stato di rovina, doveva 
        essere il castello nel 1575, quando era distinta la &quot;casa da gentilhuomo&quot; 
      dal &quot;castelletto&quot;. L'antica destinazione, cio&egrave;, si era 
        ormai trasformata, come di consueto nelle architetture fortificate, essendosene 
        altres&igrave; conclusa la destinazione difensiva: con intenti simili 
        ...
        ma anteriormente sin dal 1513, da Massimiliano Sforza altres&igrave; accordato, 
        quale feudo, proprio alla medesima casata dei Brivio.<br>
      ...
      scansione spaziale che ne segu&igrave;, variamente articolata nei corpi 
        di fabbrica costituenti il castello.<br>
        ...
        sono, cos&igrave;, gli interventi minori i quali, legati a tale destinazione, 
        rendono poco visibili, anche ai fini dello studio, varie parti del castello.<br>
        Questo non &egrave; che uno dei tanti problemi inerenti al notevole stato 
        di degrado in cui si trova, attualmente, il castello di Zivido: vale a 
        dire una situazione che contribuisce ad accentuare le difficolt&agrave; di uno studio relativo agli affreschi.<br>      
        <br>
      (di G.B.Sannazzaro da <a href="../../attivita/zivlibro.php">&quot;Zivido, 
        mille anni di storia. Dall'alto medioevo alla battaglia dei giganti&quot;</a>, 
        pp.158, 159-160, 163, 167, Associazione Culturale Zivido, 1994)</p></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top"><p class="piepagina"><a href="../tuttozivido/tuttoziv.php">tuttoZivido</a> 
      - <a href="/zivido/index.php">home</a> </p></td>
  </tr>
</table>
<br>
<p class="piepagina"><a href="../../index.php"><img src="../ppplogoacz.jpg" width="61" height="95" border="0"></a><br>sito di proprietà della <a href="../../index.php">Associazione Culturale Zivido</a><br>
