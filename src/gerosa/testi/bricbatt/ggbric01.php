...
?><html>
<head>
<title>Il mito di Valentina Visconti</title>
...
.Stile4 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 11px; font-weight: bold; }
-->
</style>
</head>
<body>
  ...
  <tr>
    ...
    <td width="70%" align="left" valign="top"><table width="98%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#62B0FF">
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td align="left" valign="top"><p><br><strong>Il mito di Valentina Visconti</strong><br>
              <br>
Dal castello di Marignano scendeva non senza pompa, nonostante che infuriasse la peste, il corteo funebre con cui portavano a Viboldone le spoglie del duca Gian Galeazzo, il quale era stato spazzato via in pochi giorni da quella &quot;pestilente febbre&quot; e veniva deposto in tale abbazia per avere successivamente pi&ugrave; degna sepoltura nella Certosa di Pavia.<br>
Era il duca di Milano piamente devoto di Sant'Antonio di Vienne, quello dei porci, ed aveva disposto che lo mettessero nella bara vestito dell'abito di professo religioso di quel Santo; la religiosit&agrave; dei nostri principi, secondo le costumanze dei tempi assai profonda, doveva servire in morte a rendere meno inclemente il Cielo per i numerosi delitti commessi contro la vita e la libert&agrave; altrui.<br>
La scomparsa prematura del primo duca di Milano, affermano gli storici, era oggetto di una grande general commozione alla quale partecipava anche il firmamento, poich&egrave; alcuni giorni prima della sua morte arse nel cielo una gran cometa, &quot;con una lunghissima squalida e mortal coda, verso quella parte che volta al vento di Maestro&quot; (Giovio).<br>
Altro che commozione invece quel mattino in cui, partito da Pavia per recarsi in pellegrinaggio al Sacro Monte di Varese, finse di voler ossequiare lo zio Bernab&ograve; Visconti, il quale discese dal castello senza scorta fino alla Pusterla di Sant'Ambrogio; e l&igrave; te lo fece accalappiare dai suoi sgherri e rinchiudere per alcun tempo nella rocca di trezzo, dove alla fine se ne liber&ograve; con un bel piatto di fagioli avvelenati.<br>
E cos&igrave; rimaneva unico e solo padrone del ducato di cui riusc&igrave; anche a farsi avere l'investitura dall'imperatore Venceslao <strong>(1)</strong>, ma allo scoppio della peste pens&ograve; bene di lasciare la sua residenza di Pavia per ritirarsi in Marignano, castello molto ameno sul fiume Lambro, dice il Coiro, dove si preoccup&ograve; anche di apparecchiare i regi ornamenti per farsi coronare Re d'Italia.<br>
Il suo esercito marciava vittorioso in Toscana ed aveva cacciato in corpo tanto spavento ai Fiorentini &quot;che i cittadini, perduti d'animo, non mettevano pi&ugrave; speranze nella salute loro, n&egrave; in guardie, n&egrave; in difesa, ma solo nella morte del potentissimo et corocciato nemico&quot;. La quale augurata morte non si fece aspettare, il 3 settembre 1402, ed invece dei regi ornamenti lo rivestirono del saio monacale di Sant'Antonio dei porci, secondo il suo pio desiderio.</p></td>
        </tr>
      </table>
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#62B0FF">
        <tr>
          <td width="5%">&nbsp;</td>
          <td width="92%"><span class="Stile4">Nota 1 </span></td>
        </tr>
      </table>
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td><p>L'investitura imperiale venne ottenuta da Giangaleazzo a peso d'oro, ma il ducato di Milano non aveva prezzo; contava pi&ugrave; d'ogni altra cosa il fatto che la grande avventura dei Visconti era in continuo crescendo, da quando, padroni solo &quot;di quattro et veramente ignobili ville&quot; come scrive il Giovio, giunsero al dominio del principale stato italiano. Con tutto il rispetto degli abitatori di oggid&igrave;, le ignobili ville citate dal nostro storico erano: Invorio, Massino, Verganto ed Oleggio. </p></td>
        </tr>
      </table>
      <table width="98%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        ...
        <tr>
          <td align="center" valign="top"><img src="/gerosa/testi/bricbatt/images/vale.png" width="400" height="346"></td>
        </tr>
      </table>
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td align="center" valign="top"><span class="Stile2"><strong>Ingresso a Parigi di Valentina Visconti a fianco della regina</strong><br>
          (da un codice miniato dell'epoca) </span></td>
        </tr>
      </table>
      <br><br>
    </td>
