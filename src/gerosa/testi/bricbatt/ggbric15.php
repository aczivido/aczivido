...
?><html>
<head>
<title>La favola del pellicano</title>
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td align="left" valign="top"><p><br>
              <strong>La favola del pellicano</strong><br>
            <br>
Le nozze furono trattate dal duce Louis de Longueville che era prigioniero in Inghilterra dopo la Journ&eacute;e des Eperons: chi dice che il Re, piuttosto serio nella vita pubblica, avesse per&ograve; ancora delle cocenti velleit&agrave; sentimentali, nonostante con un piede gi&agrave; nella tomba; altri invece afferma che si arrese a quel &quot;sacrificio&quot; unicamente per il benessere del suo popolo (M&eacute;zeray). &quot;Ainsi le bon Prince se sacrifia, dit un auteur, comme fait le Pelican pour la salut des siens&quot;.<br>
Sta di fatto che la mira politica che aveva spinto il Re d&#146;Inghilterra ad accordare quelle nozze era bene evidente: puntare sulla possibilit&agrave; di dare a Luigi XII, uomo finito, un erede diretto da mettere poi sul trono in luogo del focoso e pericoloso duca d&#146;Angoul&egrave;me. Il matrimonio fu consumato ad Abb&eacute;ville il 10 ottobre e dopo poche settimane il letto nunziale si trasform&ograve; in catafalco: il sovrano moriva quasi improvvisamente la notte dell&#146;ultimo dell&#146;anno, quando la nuova spedizione per la riconquista del Milanese era gi&agrave; pronta.</p></td>
        </tr>
      </table>
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td width="50%" align="center" valign="top"><img src="/gerosa/testi/bricbatt/images/sale.png" width="293" height="250"></td>
          <td width="50%" align="center" valign="middle"><span class="Stile9"><strong>Saliera in oro di Francesco I</strong><br>
            E' un prezioso capolavoro di Benvenuto Cellini<br>
            cui era stata commissionata in origine<br>
            dal cardinale Ippolito d'Este.<br>
          (Vienna - Kunsthistorisches Museum)</span></td>
        </tr>
      </table>
      </td>
  </tr>
