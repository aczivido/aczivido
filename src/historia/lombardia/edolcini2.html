...
<title>Emanuele Dolcini - Dov'&egrave; morto Severino Boezio?</title>
<style type="text/css">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td width="78%" valign="top" align="left" bgcolor="#E8E8E8"> 
      <p align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Dov'è 
        morto Severino Boezio?</font> <font face="Verdana, Arial, Helvetica, sans-serif" size="2">Viaggio 
        tra le ricchezze di Santa Maria Assunta</font><br>
        <font face="Verdana, Arial, Helvetica, sans-serif" size="1">di Emanuele 
        Dolcini</font></p> 
    </td>
  ...
  <tr> 
    <td width="78%" valign="top" align="left"> 
      <p ALIGN="JUSTIFY"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><br>
        ...
        valore storico in sè, hanno contribuito a mutare sensibilmente i termini 
        di un'affascinante ed un po' dimenticata questione che si lega proprio 
        a questa località: quella del luogo di morte del filosofo cristiano tardoantico 
        Severino Boezio. L'essenza del &quot;giallo&quot; è questa: di Severino 
        Boezio (+ 524 d.c.), autore del De Consolatione Philosophie, si sa con 
        certezza quando e come morì - per pena capitale comminata da Teodorico, 
        re degli Ostrogoti - ma non con altrettanta sicurezza dove. Le cronache 
        medievali, che salgono sino alla stessa età boeziana, indicano come luogo 
        dell'esecuzione un &quot;ager Calventianus&quot; ovvero &quot;Calventianum&quot;, 
        da identificarsi con qualcuna delle moderne località lombarde che portano 
        il nome Calvenzano. Piuttosto improbabile che Boezio sia morto in Calvenzano 
        bergamasco (l'unico, attualmente, a far comune a sè) o nel piccolo Calvenzano 
        frazione di Caselle Lurani (Lo), la querelle si è sempre sviluppata fra 
        ...
        obiezione, come si è ampiamente visto, sembra caduta: Calvenzano di Vizzolo, 
        sviluppato con ogni probabilità attorno ad un luogo di culto, esisteva, 
        ...
        nel contesto dell'età romano-barbarica, che poteva caratterizzare Ticinum, 
        ...
        può presumere che Calvenzano di Vizzolo non fosse molto più che un modesto 
        borgo rurale.<br>
        ...
        di papa Leone XIII. Nonostante ciò, ciascuna delle due chiese che, quindici 
        secoli fa, potrebbero aver fatto da sinistro scenario dell'esecuzione 
        del filosofo, presenta un'epigrafe avocante a sè il tragico e nobile fatto. 
        A Calvenzano di Vizzolo, sul lato nord, il 23 ottobre 1947 ne è stata 
        ...
        Ciel d'Oro (restaurata, ma di età sicuramente medievale) ed una, più recente, 
        nel tempio dei SS.Gervaso e Protaso.<br>
        <br>
        <b>Boezio ed il suo tempo</b><br>
        Anicio Manlio Severino Boezio, nato a Roma verso il 480 d.c., si trovò 
        ...
        la penisola al precedente &quot;inquilino&quot; barbarico Odoacre.<br>
        Boezio fece parte della cerchia di uomini politici, letterati e consiglieri 
        latini più vicini a Teodorico, che, com'è noto, risiedeva ordinariamente 
        a Ravenna. Il regno del sovrano goto, nelle fonti coeve, ci è descritto 
        come un periodo di (relativa) pace e prosperità dopo un secolo, quello 
        ...
        non è dato saper; certo è che le cose ad un certo punto cambiarono, perchè 
        ...
        guerra greco-gotica che devastò ulteriormente il nostro povero Paese. 
        ...
        non quello classico, bensì un latino &quot;tecnico&quot;, con molti adattamenti 
        ...
        riuscì solo in parte, con la versione latina delle opere logiche di Aristotele 
        ...
        di testimone di un'età che sfuma in un'altra è sempre stato individuato 
        ...
        allora nascenti del cristianesimo.<br>
        <br>
        <b>Un po' di critica</b><br>
        Premettendo, dunque, che il futuro della ricerca non è mai scritto in 
        ...
        relativamente a tutta la questione; certo è che tale conclusione è raggiunta 
        dopo un'esegesi estremamente accurata, che non sembra formulare obiezioni 
        per partito preso o per il semplice gusto di difendere una tesi campanilistica.<br>
        <b>1)</b> Il più antico documento che offre informazioni sulla morte di 
        Severino Boezio è il Chronicon di Mario Aventicense, vescovo della città 
        ...
        della Maxima sequanorum o Elvetia romana, ma - osserva il Gianani - c'è 
        ...
        milanese piuttosto che quello di Ticinum. Inoltre il Chronicon è un testo 
        ...
        (Freculfo vescovo, Onorio d'Autun) si può pensare che si limitino a copiare 
        Mario.<br>
        <b>2)</b> C'è poi il documento noto come Anonimo Valesiano o Annales Valesiani: 
        ...
        è una delle fonti più ampie di cui disponiamo. Il problema sollevato dagli 
        Annales è che il passo relativo a Boezio si presta ad una doppia lettura. 
        Alcuni, fra cui il Gianani, lo leggono infatti così: &quot;Rex (Teodorico, 
        ...
        re (Teodorico) dunque convocò Eusebio, prefetto di Roma (o di Ticinum, 
        ...
        rurale) che si intuisce distinto dalla città di Ticinum. In questo caso 
        il Gianani osserva: quanto è attendibile, sia pure considerando la sintassi 
        latina imbarbarita dei secoli bassi, una dizione così tortuosa come la 
        seconda, che ripete un soggetto (&quot;rex&quot;) a distanza tanto ravvicinata?<br>
        <b>3)</b> C'è infine l'opinione di Ludovico Antonio Muratori. L'illustre 
        storico, redigendo i monumentali Annali d'Italia, riscoprì anche l'Anonimo 
        Valesiano suffragando l'idea che l'&quot;ager Calventianus&quot; indicato 
        dal cronista fosse in effetti quello di Vizzolo. Ma anche qui ci si può 
        domandare: è più probabile che il Muratori, vissuto a Modena per grandissima 
        ...
        quello milanese, abbia indicato l'unico di cui era sicuro?</font></p>
      </td>
    <td width="2%" valign="top" align="left"></td>
    <td width="20%" valign="top" align="center" bgcolor="#FFFFFF"> 
      <p><br>
        <font face="Verdana, Arial, Helvetica, sans-serif" size="1">da IL MELEGNANESE<br>
        n.20/1999<br>
        sabato 13 novembre 1999<br>
        <br>
        <img src="../image/boezio.jpg" width="145" height="130"><br>
        Boezio nella sua prigione,<br>consolato dalla Filosofia.<br>
        Miniatura di un codice del<br>&quot;De Consolatione<br>Philosophie&quot;<br>
        del sec. XI<br>
        (Parigi,<br>Biblioteca Nazionale)</font></p>
      </td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
