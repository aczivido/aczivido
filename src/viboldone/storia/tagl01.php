  ...
  <tr> 
    <td valign="top" width="100%"> 
      <p ALIGN="JUSTIFY"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Gli 
        ...
        <br>
        <b>Viboldone alle origini dell'Ordine Umiliato</b><br>
        Una città umiliata, vilipesa, distrutta è la Milano che si fece incontro 
        al suo nuovo arcivescovo Galdino, rientrato in sede nel 1167 dopo la distruzione 
        del temibile comune lombardo decretata dal Barbarossa nel 1162. Ma è in 
        questa stessa città che, ben presto, si assiste a una ripresa dello spirito 
        ...
        comunità di <em>fratres et sorores</em> che proprio nel decennio dell'episcopato 
        trascorso da Galdino a Milano cominciano a diffondersi nella città lombarda, 
        e che costituiscono la base anonima, indistinta, inafferrabile eppure 
        intuibile del movimento degli Umiliati, così chiamati &quot;perchè - attesta 
        il domenicano Umberto de Romans - conducono l'umile vita dei lavoratori&quot;, 
        o anche, secondo lo scrittore del <em>Chronicon universale</em> di Laôn, 
        ...
        &quot;In quel tempo - la data di riferimento è il 1178, ma ovviamente 
        il quadro del discorso va contestualmente esteso ad almeno tutto il decennio 
        precedente, poichè nel 1178 gli Umiliati già emergono nella documentazione 
        - alcuni cittadini, <em>cives quidam</em>, nella varie città lombarde, 
        ...
        dalle liti nei tribunali, usando vesti semplici, cioè non tinte, e consacrandosi 
        alla difesa della fede cattolica, <em>pro fide catholica se opponentes</em>&quot;. 
        Proprio come Galdino, verrebbe da dire, strenuo difensore del dogma cattolico 
        al punto da morire sul pulpito - così vuole la tradizione - al termine 
        di un'infuocata predica contro gli eretici che a Milano, <em>fovea hereticorum</em>, 
        pullulavano come in nessun'altra città, secondo quanto attesta Giacomo 
        ...
        alcuni all'eresia catara, imparentati da altri con i Valdesi. In verità, 
        è piuttosto un movimento da considerarsi come &quot;una efflorescenza 
        ...
        per opera di Innocenzo III allo schiudersi del XIII secolo, dopo però 
        ...
        l'intero movimento, che non smarrì del tutto l'impronta ortodossa delle 
        origini; anzi, tra le comunità umiliate, nella quasi generalità, prese 
        ben presto impulso un movimento di ritorno alla gerarchia ecclesiastica, 
        se già nel 1199 si avvertì, da parte dello stesso Innocenzo III, la necessità 
        ...
        Si trattò pertanto di una &quot;breve avventura ereticale - come recentemente 
        l'ha qualificata uno dei maggiori esperti dei movimenti ereticali del 
        medioevo - sulla quale ebbe tuttavia il sopravvento il processo che favorì 
        ...
        fraternità monastica propriamente detta di professi e professe; il secondo 
        ...
        ciascun gruppo con &nbsp; una propria regola o <em>propositum</em>, promulgata 
        da Innocenzo III - come s'è appena detto - ai primi del secolo XIII.<br>
        La storia immediatamente successiva è quella di un ordine che, nonostante 
        ...
        vescovo Giacomo da Vitry, quando afferma: &quot;In tutta la città di Milano, 
        <em>fovea hereticorum</em>, a stento si sarebbe potuto trovare che fosse 
        ...
        col nome di patarini (eretici). Dal sommo pontefice però, dal quale hanno 
        l'autorità di predicare e di confutare gli eretici, e dal quale anzi la 
        loro religione venne approvata, sono chiamati Umiliati&quot;.<br>
        E' su questo sfondo che si stagliano le origini e i primordi di una delle 
        quattro più importanti comunità umiliate, preposte nel 1201 da Innocenzo 
        III al governo del nuovo ordine. Si tratta della <em>domus de Vicoboldono</em>, 
        ...
        la cui costruzione venne realizzata nel 1348 - non sfuggì all'attenzione 
        ...
        maggio, in realtà) disconfitus fuit imperator Federicus ad Legnanum a 
        ...
        in loco Vicoboldono&quot;, che cioè si sarebbe dovuta edificare a Viboldone, 
        non era estraneo l'ambiente - nè poteva esserlo, poichè si trattava pur 
        ...
        S. Giuliano. <br>
        Prendeva così avvio, sotto i carismi delle autorità diocesane, la costruzione 
        ...
        è ancora trovata documentazione anteriore al 1189. Un'origine pienamente 
        ...
        notizia in un processo del 1322.<br>
        ...
        di deviazione ereticale dalla fondazione umiliata di Viboldone.<br>
        <br>
