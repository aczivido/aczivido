  ...
  <tr> 
    <td valign="top" width="100%"> 
      <p ALIGN="JUSTIFY"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Gli 
        ...
        Tagliabue<br>
        <br>
        <b>Un fiume tra le propriet&agrave;: la Vettabbia</b><br>
        ...
        gi&agrave; nell'alto medioevo: la Vettabbia.<br>
        ...
        e di fossati collegati con il medesimo corso d'acqua. Ma ci&ograve; che 
        ...
        al re Rodolfo I d'Asburgo, la cui suprema autorit&agrave; era stata riconosciuta 
        ...
        sue acque &egrave; costante nelle carte patrimoniali dei secoli successivi, 
        poich&egrave; si trattava di una indubbia fonte di ricchezza per la nostra 
        comunit&agrave;. Quelle acque costituivano infatti un insostituibile forza 
        ...
        cui investire i proventi dell'attivit&agrave; manifatturiera e commerciale. 
        Questo orientamento, nel caso di Viboldone, port&ograve; ben presto alla 
        costituzione di un ingente patrimonio fondiario, non senza l'apporto di 
        donazioni sul tipo di quella dei Polvale, ricordata poco sopra.<br>
        ...
        (tab.1) ricostruito sulla base del pi&ugrave; volte citato processo del 
        1322, dal quale &egrave; stato possibile ricavare indicazioni sufficientemente 
        esaustive sia in rdine all'estensione sia in ordine alla produzione.<br>
        In assenza di studi preliminari non &egrave; possibile seguire oltre l'evoluzione 
        di questo patrimonio. Qui basti dire che nel Quattrocento, secolo di profonde 
        trasformazioni per le propriet&agrave; fondiarie ecclesiastiche, non si 
        ha pi&ugrave; notizia di ulteriori acquisti di immobili, quanto piuttosto 
        ...
        risorgive e di rogge di propriet&agrave; della nostra prepositura, data 
        ...
        stava ammassando nel Lodigiano.<br>
        Parallelamente, unit&agrave; fondiarie compatte e di vasta portata, come 
        ...
        instaurati, altres&igrave;, con altri robusti enti monastici quali Chiaravalle 
        ...
        Nel suo insieme tuttavia si tratt&ograve; di un patrimonio consolidatosi 
        ...
        o di tenute in zone pi&ugrave; lontane: tali, per esempio, le terre allivellate 
        ai da Terzago nei territori di Trezzo, Colnago e Busnago, in pieve di 
        Pontirolo, lungo la riva destra dell'Adda.<br>
        A propriet&agrave; fondiarie concentrate nella zona di epicentro della 
        ...
        in Roncole Lodigiano o per lo pi&ugrave; intorno alle cascine che ben 
        ...
        da san Carlo Borromeo nel 1578 in Civesio.<br>
        In linea con altri grandi latifondisti del tempo, nella gestione di una 
        propriet&agrave; fondiaria tanto ingente, gli Arcimboldi mirarono alla 
        creazione di appoderamenti pi&ugrave; compatti, ottenuti tramite scambi 
        ...
        de Viboldono&quot;, distante mezzo miglio o poco pi&ugrave; dal villaggio. 
        ...
        i beni della prepositura per 18.500 lire di affitto.<br>
        ...
        l'avanzare di una industrializzazione sempre pi&ugrave; inquinante), e 
