...
<title>Laura Cavazzini - La Madonna di Riozzo</title>
<style type="text/css">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td width="78%" valign="top" align="left" bgcolor="#E8E8E8"> 
      <p align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Forse 
        vegliava su Porta Vercellina<br>
        <font size="2">La Madonna di Riozzo, una scultura da riscoprire</font> 
        <a href="../image/cav.jpg"><font color="#0000FF">(immagine)</font></a> 
        <br>
        di Laura Cavazzini</font></p> 
    </td>
  ...
  <tr> 
    <td width="78%" valign="top" align="left"> 
      <p ALIGN="JUSTIFY"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><br>
        La Vergine, coronata, siede solenne su di un semplice sedile, reso pi&ugrave; 
        ...
        Madre e del Bambino una coppia di angioletti svolge una cortina.<br>
        Il grande altorilievo &egrave; complessivamente in discreto stato di conservazione, 
        nonostante diverse scheggiature e alcune pi&ugrave; importanti lacune: 
        si devono in particolare a un rifacimento (si direbbe cinque-seicentesco) 
        la testa dell'Angelo di sinistra cos&igrave; come quella del piccolo Ges&ugrave;, 
        che oggi guarda verso lo spettatore, ma che doveva in origine volgersi, 
        quale la madre, verso destra; ancora &egrave; malamente rifatta in stucco 
        la punta del naso di Maria.<br>
        Nonostante la qualit&agrave; non comune che la contraddistingue, la scultura 
        di Riozzo &egrave; rimasta finora relegata ai margini degli studi storico-artistici. 
        Venne esposta tra il 1979 e il 1980 a Palazzo Reale, in occasione della 
        mostra &quot;Sette secoli di storia e arte: dal <i>pane vino e zoccoli</i> 
        ...
        alla fondazione della Certosa di Pavia.<br>
        In verit&agrave;, il marmo dell'oratorio di S. Rocco trova le sue radici 
        stilistiche in un tratto della storia della scultura lombarda che sta 
        tutto a monte della fondazione della Certosa, avvenuta nel 1396 per volont&agrave; 
        ...
        lavori di costruzione e decorazione del Duomo di Milano e che in pi&ugrave; 
        di un'occasione furono convocati anche a Pavia per dare pareri e consigli. 
        La solenne monumentalit&agrave;, lo sguardo severo, quasi altero, la solida, 
        ...
        con ogni probabilit&agrave; nel corso del quinto decennio del Trecento, 
        ...
        attesta una <a href="../../viboldone/largfoto/abbazia/vib19.jpg"><font color="#0000FF">lapide</font></a> 
        in facciata), mentre Salvarino Aliprandi mor&igrave;, secondo l'iscrizione 
        che corre lungo il bordo inferiore del sarcofago, nel 1344.<br>
        Al loro autore, che dovremmo abituarci a chiamare, dall'opera sua pi&ugrave; 
        caratteristica, Maestro delle sculture di Viboldone (perifrasi un po' 
        faticosa, che evita per&ograve; la confusione con l'altrettanto anonimo 
        ...
        a tutto tondo e un rilievo con Cristo in piet&agrave; al Castello Sforzesco, 
        ...
        del tutto la sola scultura bergamasca (non sconosco per&ograve; il marmo 
        del santuario di Castelletto).<br>
        E', questo maestro delle sculture di Viboldone, una personalit&agrave; 
        chiave nella vicenda della statuaria milanese d'et&agrave; gotica, che 
        ...
        dalla met&agrave; del secolo, l'affermazione perentoria di Bonino da Campione, 
        destinato a divenire il nuovo artefice di fiducia dei signori dello Stato 
        milanese.<br>
        Tra questi due poli non v'&egrave; dubbio che il maestro anonimo trovi 
        maggiori consonanze con Bonino, del quale lo si vorrebbe credere il maestro, 
        tante e tali sono le affinit&agrave; tra il suo eloquio chiaro ma solenne, 
        ...
        il Maestro delle sculture di Viboldone altri non sia in realt&agrave; 
        che Bonino stesso nella sua fase pi&ugrave; antica, se non fosse per il 
        tono pi&ugrave; solenne, la monumentalit&agrave; pi&ugrave; perentoria, 
        ...
        Milano.<br>
        La questione, cruciale al fine di una pi&ugrave; aderente e articolata 
        interpretazione della scultura medievale lombarda, merita un esame che 
        non &egrave; dato condurre nel poco spazio di una scheda, esame che comporter&agrave; 
        ...
        finite, chiss&agrave; per quali vie, sul tiburio del Duomo milanese (pubblicate 
        ...
        appunto. L'assoluta identit&agrave; iconografica trova puntuale riscontro 
        ...
        restauratore che gir&ograve;, rifacendola, la testa del bimbo a interloquire 
        ...
        il gruppo apparir&agrave; a maggior ragione fuori scala all'interno del 
        piccolo oratorio di S. Rocco, cos&igrave; come fuor di misura per quella 
        sede non pu&ograve; non risultare l'impegno, artistico innanzitutto ma 
        anche economico, che un'opera siffatta sottintende. E d'altra parte le 
        vistose rotture del marmo sono di per s&egrave; indizio di traslocchi 
        traumatici: ricerche che non ho avuto ancora modo di fare nell'Archivio 
        II.PP.A.B. potranno forse gettare luce sulle modalit&agrave; e i tempi 
        che l'han fatto approdare a Riozzo.<br>
        Mi limiter&ograve; per ora a notare che l'identit&agrave; iconografica 
        e tipologia (sia tratta di due sculture ad altissimo rilievo, per di pi&ugrave; 
        ...
        che realizz&ograve; (con l'aiuto dell'operosa bottega) le figure delle 
        porte Ticinese, Comacina e Orientale. A un certo punto gli succedette 
        nell'impresa (o forse solo lo affianc&ograve;) il Maestro della sculture 
        ...
        demolita, come attesta Paolo Morigia nella <i>Historia dell'antichit&agrave; 
        di Milano</i>, gi&agrave; nel Cinquecento, quando la realizzazione, sulla 
        met&agrave; di quel secolo, dei nuovi bastioni voluti da Ferrante Gonzaga 
        innescava il progressivo degrado delle mura e delle porte medievali, via 
        via sacrificate alle esigenze della citt&agrave; in corso di trasformazione.<br>
        Proprio sulla porta che conduceva a Vercelli &egrave; stato supposto troneggiasse 
        in origine la Madonna col Bambino oggi nella chiesa di S. Nicolao, opera, 
        lo abbiamo visto, del Maestro delle sculture di Viboldone.<br>
        ...
        d'esecuzione (l'altorilievo) e l'idea degli angeli reggi cortina.</font></p>
      </td>
    <td width="2%" valign="top" align="left"></td>
    <td width="20%" valign="top" align="center" bgcolor="#FFFFFF"> 
      <p><br>
        <font face="Verdana, Arial, Helvetica, sans-serif" size="1">da VIVEREINSIEME<br>
        bimestrale d'informazione<br>
        delle II.PP.A.B.<br>
        ex E.C.A. di Milano<br><br>
        anno 2 - n.1<br>
        gennaio - febbraio 2002</font></p>
      </td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
