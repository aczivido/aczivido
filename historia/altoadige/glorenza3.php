...
<title>Catastrofe e ricostruzione</title>
<style type="text/css">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td width="78%" valign="top" align="left"><font FACE="Verdana" SIZE="1"> 
      <p ALIGN="JUSTIFY"><br>
        <b><font face="Verdana, Arial, Helvetica, sans-serif">Catastrofe e ricostruzione<br>
        </font></b><font face="Verdana, Arial, Helvetica, sans-serif">I confederati 
        ...
        ostilit&agrave; si erano verificati diversi episodi che avevano contribuito 
        ...
        del tutto incapace che perdipi&ugrave; non conosceva la zona.<br>
        ...
        a pi&ugrave; piani e vi si raccolse una gran quantit&agrave; di derrate 
        alimentari. Glorenza invece rest&ograve; disarmata e le porte della citt&agrave; 
        rimasero aperte: si imband&igrave; addirittura il banchetto per festeggiare 
        ...
        La cavalleria nobile, appostata tra Schleis/Clusio e Malles, non attacc&ograve;. 
        Forse per rivalit&agrave; nei confronti della fanteria oppure per il terrore 
        di venire massacrati in quanto i soldati svizzeri erano molto temuti.<br>
        ...
        tutti i maschi di et&agrave; superiore ai 12 anni massacrati, ragazze 
        e donne violentate. Non si fecero prigionieri. Quindi la citt&agrave; 
        ...
        davanti alla porta Venosta e quindi trucidati dalla folla inferocita.<br>
        ...
        alla ricerca di erbe e radici con cui sfamarsi. Ludovico il Moro invi&ograve; 
        notevoli quantitativi di cereali che a quanto pare raggiunsero solo in 
        parte i destinatari. Dello splendore di Glorenza non rimaneva pi&ugrave; 
        traccia.<br>
        I cadaveri non vennero rimossi. Il 29 maggio Massimiliano, al seguito 
        di un esercito di 8000 uomini, visit&ograve; il campo di battaglia disseminato 
        di corpi esanimi e piangendo alla vista di quello spettacolo raccapricciante 
        promise la ricostruzione della citt&agrave; di Glorenza, che in questo 
        modo avrebbe acquistato quell'aspetto di cittadina tardo medievale, che 
        ancor oggi possiamo ammirare.<br>
        Questa ricostruzione fu per&ograve; segnata da una certa lentezza bench&egrave; 
        il primo progetto per le nuove mura fosse pronto gi&agrave; poco dopo 
        ...
        lavori procedevano lentamente, pich&egrave; mancava anche il personale 
        ...
        tutto le proprie abitazioni.<br>
        Nella furia del momento scoppi&ograve; un incendio in una fornace da mattoni; 
        in seguito una commissione d'inchiesta stabilir&agrave; che le feritoie 
        ...
        lontane citt&agrave; di Vienna e Praga e non solo a Innsbruck si riteneva 
        che Glorenza come citt&agrave; di confine avesse una grande importanza 
        ...
        fiorire il contrabbando di armi con gli Svizzeri, e perci&ograve; possiamo 
        affermare che il contrabbando in epoca posteriore si rif&agrave; a un'antica 
        ...
        della citt&agrave; si impiegarono 60 quintali di ferro e piombo. Verso 
        ...
        del 1607 evidenzia come in breve tempo le fortificazioni dell'et&agrave; 
        moderna si resero inutili, infatti a proposito di Glorenza vi si pu&ograve; 
        ...
        Questa sentenza equivaleva a un abbandono della citt&agrave;&quot; dichiarata 
        praticamente indifendibile.<br>
        <br>
        </font></p>
      </font></td>
    <td width="2%" valign="top" align="left"></td>
