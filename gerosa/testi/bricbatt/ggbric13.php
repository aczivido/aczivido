...
?><html>
<head>
<title>Il Re avventuroso e galante</title>
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td align="left" valign="top"><p><br>
              <strong>Il Re avventuroso e galante</strong><br>
            <br>
            <span class="citazione">&quot;Mon fils, mon Roy, mon C&eacute;sar!&quot;</span> si dice che esclamasse la duchessa d&#146;Angoul&egrave;me correndo per le sale del castello, quando le venne recapitata la notizia della morte repentina di Luigi XII il Pdre del popolo. &quot;Mio figlio, il mio Re!&quot;, il sogno di tutta una vita, la nascosta brama covata per lunghi anni all&#146;ombra di una corte, un desiderio che si accresceva e prendeva forma di realt&agrave; man mano che la falce della morte toccava inesorabile il trono e la corona, ed assisi sui gradini del trono &quot;gli arbusti lieti di lor rame giovani&quot;&#133;.<br>
Giunta sposa alla corte di Francia all&#146;et&agrave; di 12 anni vide morir giovane il Re Carlo VIII, di banal morte per aver dato la testa contro una porta bassa; il marmoreo sepolcro leggiadro di amorini e di ghirlande della cattedrale di Tours si era gi&agrave; chiuso sui due figlioletti del Re; il triplice letto nunziale del Padre del popolo non aveva dato maschi.<br>
Luisa di Savoia duchessa d&#146;Angoul&egrave;me aveva fatto voto a S. Francesco da paola che se le fosse stato concesso il desiderato maschio gli avrebbe imposto quel nome; ed il voto fu esaudito nel 1494 ai 12 di settembre quando nel castello di Cognac venne alla luce il gran rampollo. Il suo orgoglio di madre era coronato e la sua ambizione divenne libidine di potere quando, mortole il marito nel 1496, Francesco monsignore duca d&#146;Angoul&egrave;me divenne il principe maschio pi&ugrave; vicino alla linea reale per il caso di successione. Il Re Luigi XII, come capo della casa di Orl&eacute;ans, ne assunse la tutele e gli si affezion&ograve; come un padre e Luisa di Savoia appunt&ograve; sul figlio tutte le sue cure e lo segu&igrave; e lo circond&ograve; di tutta la sua persoanle sorvewglianza, con che gli venne dtata un&#146;educazione confacente al suo possibile avvenire regale.<br>
Francesco era un bel ragazzo, intelligente, che vieppi&ugrave; si affinava nello studio, nella attrazione delle arti belle, nelle discipline militari, ed anche nella precoce arte del godere e del piacere alle donne. Cos&igrave; poco pi&ugrave; che ventenne, la prima monarchia d&#146;Europa conobbe in lui un Re forte nelle membra e dalla mente aperta e vivace, temprato al coraggio nell&#146;uso delle armi e lo spirito alle pi&ugrave; belle espressioni dell&#146;arte e della cultura, epperci&ograve; portato a favorire e proteggere quel gioioso tripudio del Rinascimento francese che da lui fa epoca nelle sue pi&ugrave; meravigliose manifestazioni, volti i sensi ed i doni di natura ad una concezione edonistica della vita che ne fa tradizionalmente il Re dell&#146;amore e della galanteria.<br>
Sorge con Francesco I la gran corte di Francia che avr&agrave; un crescendo culminante coi suoi successori e finir&agrave; fra i suplizi della Rivoluzione; &quot;una folla pittoresca, pazzamente lussuriosa di gentiluomini e dame, che fa da cornice quotidiana al monarca. Le caccie, le giostre, le danze, la galanteria, i viaggi, le entrate solenni, fanno della vita di corte una festa ed una rappresentazione continua&quot; (L.F.Benedetto).</p></td>
        </tr>
      </table>
      ...
      <table width="98%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="10%">&nbsp;</td>
          <td width="80%" align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
            <tr>
              <td align="center" valign="top"><a href="/zivido/igiganti/personaggi/franceprimo.php"><img src="/gerosa/testi/bricbatt/images/francescoI.png" width="300" height="400" border="0"></a><br>
                <table width="59%"  border="0" cellspacing="5" cellpadding="0">
                  <tr>
                    <td align="center" valign="top"><span class="Stile6"><strong>Francesco I Re di Francia</strong><br>
                      Dipinto di Jean Clouet <br>
                      Parigi, Louvre </span></td>
                  </tr>
                </table>
                </td>
            </tr>
      ...
      <table width="98%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="80%" align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
            <tr>
              <td width="60%" align="center" valign="top"><img src="/gerosa/testi/bricbatt/images/castle1.png" width="250" height="341"></td>
              <td width="40%" align="left" valign="middle"><p><strong>Il Castello di Chambrod</strong><br>
                    <br>
                    E' l'espressione pi&ugrave; completa<br>del Rinascimento francese,<br>voluto da Francesco I.<br>
                    <br>
                    La pianta di questa meravigliosa<br>costruzione &egrave; dovuta a<br>Domenico da Cortona,<br>se non addirittura a Leonardo.<br>
                    <br>
                Una foresta di camini,<br>torrete e pinnacoli &egrave; coronata<br>da una lanterna a fior di giglio.</p></td>
            </tr>
          </table></td>
          <td width="10%">&nbsp;</td>
        </tr>
