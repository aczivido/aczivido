...
?><html>
<head>
<title>La passeggiata di Carlo VIII</title>
...
.Stile3 {font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif;}
-->
</style>
</head>
<body>
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td align="left" valign="top"><p><br>
              <strong>La passeggiata di Carlo VIII<br>
              </strong><br>
Luigi XI <strong>(1)</strong> eredita i diritti della casa d'Angi&ograve; sul regno di Napoli, ma assai prudentemente si guarda bene dal farli valere; tocca al suo successore Carlo VIII, figlio del secolo, di puntare su quel possesso per aspirare alla conquista di Costantinopoli, caduta in mano dei Turchi; quindi non pretese dinastiche, ma sete di dominio, delirio di grandezza.<br>
La passeggiata di Carlo VIII attraverso la penisola arriva ad una brutta svolta quando tutti gli stati italiani che gli hanno fatto grandi inchini al suo arrivo, lo attendono ad un passo obbligato sulla via del ritorno. La battaglia di Fornovo costituisce sempre uno dei pi&ugrave; enigmatici fatti d'arme della storia perch&egrave; &egrave; descritta come una folgorante vittoria italiana sui nostri testi, mentre quelli francesi si vantano di averci dato una dura lezione.<br>
In sostanza serve qui l'arguta osservzione che il Verri in altri passi riporta dal Brantome, e cio&egrave; che il mondo &egrave; diviso in due parti e l'una non sa o giudica a modo suo quella che fa l'altra, e Dio che sa tutto si ride di entrambe (Ainsi, Dieu qui sait tout se mocque bien de nous!). I confederati italiani si diedero all'assalto degli immensi tesori che i Francesi si tiravano dietro, una specie di vittoriosa ruberia, ed i Francesi fecero squillare le trombe dalla gioia di essere riusciti a darsela a gambe!<br>
Luigi XII, uno dei soliti Orl&egrave;ans in attesa della corona, nella spedizione di Carlo VIII inserisce per conto proprio una puntata ad Asti, l'osservatorio politico e militare per la marcia sul ducato di Milano, ma l'ambiguo atteggiamento di Lodovico il Moro rende per allora inattuabili i suoi piani, e solo quando il Re suo cognato batter&agrave; malamente la testa contro una porta e gli lascer&agrave; via libera al trono, egli riprender&agrave; il suo ambizioso progetto.</p></td>
        </tr>
      </table>
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#62B0FF">
        <tr>
          <td width="5%">&nbsp;</td>
          <td width="92%"><p><strong>Nota 1 </strong></p></td>
        </tr>
      </table>
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td align="left" valign="top"><p>Si dice che questo Re Luigi XI era attaccatissimo alla pelle ed aveva una paura folle della morte; fra gli altri impedimenti era portatore di emorroidi che a quei tempi si consideravano uno sfogo provvidenziale, una specie di salasso favorito dalla natura; ma il nostro Re, si vede, aveva ricevuto questo favore in misura cos&igrave; abbondante che trovandosi in viaggio non ce la faceva pi&ugrave; dai dolori e dovette consultare maestro Pantaleone che era un medico pavese.<br>
            Francesco Pietrasanta ambasciatore del duca di Milano alla corte di Francia racconta che il Re si rivolse al fisico italiano parlandogli in latino - verecondia si vede della bassa materia - e lamentandosi del suo male si rammaricava per le fatiche del viaggio, il turbamento dello spirito e soprattutto <span class="citazione">&quot;propter abstinentiam, quia steti tanto absens ab uxore mea&quot;</span>. Dove si vede che un marito tanto fedele e che non poteva star lontano dalla moglie non era nato per fare la guerra. (da &quot;Il Giardino di Esculapio&quot;).<br>
          </p></td>
        </tr>
      </table>
      <table width="98%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        ...
        <tr>
          <td align="center" valign="top"><img src="/gerosa/testi/bricbatt/images/vale2.png" width="450" height="161"></td>
        </tr>
      </table>
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td align="center" valign="top"><span class="Stile2">Tomba di Valentina Visconti e del marito Luigi d'Orl&eacute;ans<br>
          </span><span class="Stile3">(gi&agrave; nella chiesa dei Celestini a Parigi)</span></td>
        </tr>
      </table>
      <table width="98%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
      ...
      <table width="98%"  border="0" cellpadding="0" cellspacing="5" bgcolor="#B9DCFF">
        <tr>
          <td width="50%" align="center" valign="top"><img src="/gerosa/testi/bricbatt/images/luigiXI.png" width="242" height="260"></td>
          <td width="50%" align="center" valign="top"><img src="/gerosa/testi/bricbatt/images/carloVIII.png" width="186" height="261"></td>
        </tr>
        <tr>
          <td align="center" valign="top"><span class="Stile2">Luigi XI re di Francia </span></td>
          <td align="center" valign="top"><span class="Stile3"><strong>Carlo VIII re di Francia</strong><br>
            Concep&igrave; giovanissimo il sogno della conquista d'Italia <br>
            (&quot;... les fum&eacute;es et gloires d'Italie&quot;) <br>
            e guid&ograve; nel 1494 la prima calata francese</span></td>
        </tr>
      </table>
    </td>
  </tr>
