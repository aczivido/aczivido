...
?><html>
<head>
<title>Neue Zurcher Zeitung</title></head>
<body> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="top" width="91%">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="right" valign="top" bgcolor="#00A3F0"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><font color="#FFFFFF">Rassegna 
            Stampa Internazionale</font></b></font></td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="top">
            <p><br><img src="nzz.gif" width="273" height="42"><br>
              <font size="1" face="Verdana, Arial, Helvetica, sans-serif">von 
              Jurg Bischoff - 21.09.1999</font> </p>
          </td>
        </tr>
      </table>
      <p><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Quartierfest 
        auf dem Schlachtfel von Marignano</b></font><font face="Verdana, Arial, Helvetica, sans-serif" 1="1" size="1"><br>
        Offizielles Gedenken und historische Volksbelustigung<br>
        <br>
        ...
        Schlosses von Zivido, in dem am zweiten Tag der Schlacht 300 Zurcher umkamen.<br>
        ...
        geschichtslose Grossstadperipherie zu birngen (vgl. auch NZZ 31.7.97).<br>
        ...
        &quot;Kindergarten G.B.Brivio&quot;.</font></p>
    </td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
